const questions = [
    {
        text: "Кто разработал язык программирования Паскаль?",
        options: ["Блез Паскаль", "Никлаус Вирт", "Деннис Ритчи"],
        correct: 1
    },
    {
        text: "В каком году был разработан язык Паскаль?",
        options: ["1960", "1970", "1980"],
        correct: 1
    },
    {
        text: "Для чего был создан язык Паскаль?",
        options: ["Для системного программирования", "Для обучения программированию", "Для разработки веб-приложений"],
        correct: 1
    },
    {
        text: "Какое ключевое слово используется для объявления переменных в Паскале?",
        options: ["var", "let", "const"],
        correct: 0
    },
    {
        text: "Какое ключевое слово используется для начала программы в Паскале?",
        options: ["start", "begin", "program"],
        correct: 2
    },
    {
        text: "Какой тип данных используется для хранения целых чисел в Паскале?",
        options: ["integer", "real", "boolean"],
        correct: 0
    },
    {
    ...
    {
        text: "Какой цикл в Паскале выполняет действия заданное количество раз?",
        options: ["while", "repeat...until", "for"],
        correct: 2
    },
    {
        text: "Какое ключевое слово используется для объявления процедуры в Паскале?",
        options: ["function", "procedure", "method"],
        correct: 1
    },
    {
        text: "Какой оператор используется для условного выполнения действий в Паскале?",
        options: ["if...then...else", "switch...case", "try...catch"],
        correct: 0
    },
];
